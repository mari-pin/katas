export class Checkout{
    ...
    areMoreItemsThanOffer(item){
       
        return  this.repeatedItems[item] > this.priceOfProducts[item].specialPrice.amount
       
    }
    calculateMixedPrice(item){
        ...
        const result = this.priceOfProducts[item].price * sueltos + this.priceOfProducts[item].specialPrice.price * offer
      ...
      // console.log(arrayItems)
       const sum = arrayItems.map(item =>{
           ...
           if( this.isExactAmountOffer(item)) {
               ...
               //this.priceOfProducts[item].specialPrice.price + this.mixedPrice

           }else if( this.areMoreItemsThanOffer(item)){ 
              
               
                return  this.calculateMixedPrice(item)
           }else {
