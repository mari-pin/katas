...
//act
//playerTwo sube al nivel 7
playerTwo.levelUp(finalLevel)

//PlayerTwo nivel 7 ,,playerOne nivel 1
playerOne.attack(playerTwo,damage,canAttack)

//assert

expect(playerTwo.getHealth()).toBe(health - damage/2)
...
//act
//playreOne sube al nivel 7 
playerOne.levelUp(finalLevel)
//playeOne level 7 ,, PlayerTwo level 1
playerOne.attack(playerTwo,damage,canAttack)
...
// cuando ataque comprobar en que nivel esta cada jugador
